(module
 ...
 (func $src/utils/isNaN (param $value f64) (result i32)
  local.get $value
  local.get $value
  f64.ne
  return
 ...
 (func $src/utils/consoleLog (param $message i32)
  (local $encoded i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
 ...
 (func $src/memory/getStringLen (param $ptr i32) (result i32)
  (local $len i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $src/memory/readString (param $ptr i32) (result i32)
  (local $len i32)
  (local $buffer i32)
  (local $i i32)
  (local $4 i32)
 ...
 (func $src/utils/parseFloat (param $str i32) (result f64)
  (local $1 i32)
  (local $2 f64)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
 ...
 (func $src/memory/allocateString (param $len i32) (result i32)
  (local $ptr i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $src/memory/writeString (param $ptr i32) (param $str i32)
  (local $buffer i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
 ...
 (func $src/transactions/execute_credit_leg (param $amountPtr i32) (param $accountPtr i32) (result i32)
  (local $amount i32)
  (local $account i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $src/transactions/createErrorResult (param $message i32) (result i32)
  (local $errorMessage i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 12
  i32.sub
 ...
 (func $src/transactions/createSuccessResult (param $message i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $src/transactions/process_credit_result (param $resultPtr i32) (result i32)
  (local $result i32)
  (local $balanceStart i32)
  (local $balanceEnd i32)
  (local $balanceStr i32)
  (local $balance f64)
  (local $newBalance f64)
  (local $7 i32)
  (local $8 i32)
  (local $9 i32)
  (local $responseMessage i32)
  (local $11 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 36
  i32.sub
  ...
  i32.store offset=8
  local.get $11
  local.get $balanceStart
  call $~lib/string/String#indexOf
  local.set $balanceEnd
  local.get $balanceStart
  i32.const 9
  i32.eq
  if (result i32)
  ...
  local.get $11
  call $~lib/staticarray/StaticArray<~lib/string/String>#join
  local.tee $responseMessage
  i32.store offset=32
  local.get $responseMessage
  local.set $11
  global.get $~lib/memory/__stack_pointer
  local.get $11
  i32.store offset=4
 ...
 (func $src/transactions/execute_debit_leg (param $amountPtr i32) (param $accountPtr i32) (result i32)
  (local $amount i32)
  (local $account i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $src/utils/parseBalance (param $jsonStr i32) (result f64)
  (local $balanceStart i32)
  (local $balanceEnd i32)
  (local $balanceStr i32)
  (local $4 i32)
